...
patient_bp_r5 = Blueprint('patient_bp_r5', __name__, url_prefix="/fhir/r5")
fhir_service = FHIRService()


@patient_bp_r5.route('/Patient', methods=['POST'])
def create_patient():
    data = request.json
...
@patient_bp_r5.route('/Patient/<id>', methods=['GET'])
def get_patient(id):
...
@patient_bp_r5.route('/Patient/<id>', methods=['PUT'])
...
@patient_bp_r5.route('/Patient/<id>', methods=['DELETE'])
